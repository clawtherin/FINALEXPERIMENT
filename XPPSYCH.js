...
function SupraTrialsLoopBegin(SupraTrialsLoopScheduler) {
  ...
  for (const thisSupraTrial of SupraTrials) {
...
function SupraTestsLoopBegin(SupraTestsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSupraTest of SupraTests) {
...
function DistractorTrialsLoopBegin(DistractorTrialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisDistractorTrial of DistractorTrials) {
...
function SubliTrialsLoopBegin(SubliTrialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSubliTrial of SubliTrials) {
...
function SubliTestsLoopBegin(SubliTestsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSubliTest of SubliTests) {
...
function SupraStudyRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SupraStudyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function Distractor1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Distractor1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function InstructionsScreenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of InstructionsScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function SupraTestRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SupraTestComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function SubliStudyRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SubliStudyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function SubliTestRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SubliTestComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
